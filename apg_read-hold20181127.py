...
def main():
    ...
    with open(apg_filename, 'rb') as apgfile:
        ...
        t_start = rec_start * sample_epoch * smpls_per_rec
        t_end = (rec_start + len(ticks)) * sample_epoch * smpls_per_rec
        millisec_t = np.linspace(t_start,t_end,num=len(ticks),endpoint=False)
        print(millisec_t)
        ...
        millisec_p = np.linspace(t_start,t_end,num=len(ticks)*smpls_per_rec,endpoint=False)
        print(millisec_p)
